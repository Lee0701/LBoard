...
object SoftLayout {
    ...
    val LAYOUT_10COLS_MOBILE_WITH_APOSTROPHE = Layout(listOf(Row(listOf(
            ...
            Key(keyCode = 56, label = ".", keyWidth = 1/10f),
            Key(keyCode = 66, label = "RETURN", keyWidth = 0.15f)
    ), Row.Type.BOTTOM)), key = "10cols-mobile-with-apostrophe", nameStringKey = R.string.pref_method_soft_layout_10cols_mobile_with_apostrophe)
    ...
    val LAYOUT_10COLS_MOBILE_WITH_APOSTROPHE_NUM = Layout(listOf(Row(listOf(
            ...
            Key(keyCode = 56, label = ".", keyWidth = 1/10f),
            Key(keyCode = 66, label = "RETURN", keyWidth = 0.15f)
    ), Row.Type.BOTTOM)), key = "10cols-mobile-with-apostrophe-num", nameStringKey = R.string.pref_method_soft_layout_10cols_mobile_with_apostrophe_num)
