...
class DubeolHangulComposer(
    ...
    companion object {
        ...
        fun toCho(char: Int) = (char and 0x7f000000) or CONVERT_CHO[COMPAT_CHO.indexOf(char.toChar())].code
        fun toJung(char: Int) = (char and 0x7f000000) or STD_JUNG[COMPAT_JUNG.indexOf(char.toChar())].code
        fun toJong(char: Int) = (char and 0x7f000000) or CONVERT_JONG[COMPAT_CHO.indexOf(char.toChar())].code

        fun ghostLight(char: Int) = (char and 0x7f000000) or toCho(COMPAT_CHO[CONVERT_JONG.indexOf(char.toChar())].code)
