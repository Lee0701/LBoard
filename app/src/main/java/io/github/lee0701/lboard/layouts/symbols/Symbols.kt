...
object Symbols {
    ...
    val LAYOUT_SYMBOLS_A = Alphabet.LAYOUT_QWERTY + UniversalKeyboardLayout(LayoutLayer(mapOf(
    ...
    val LAYOUT_SYMBOLS_B = Alphabet.LAYOUT_QWERTY + UniversalKeyboardLayout(LayoutLayer(mapOf(
