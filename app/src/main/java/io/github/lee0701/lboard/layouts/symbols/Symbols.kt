...
object Symbols {
    ...
    val LAYOUT_SYMBOLS_GOOGLE = CommonKeyboardLayout(LayoutLayer(mapOf(
            45 to LayoutItem(0x0031, 0x007e),
            51 to LayoutItem(0x0032, 0x0060),
            33 to LayoutItem(0x0033, 0x007c),
            46 to LayoutItem(0x0034, 0x2022),
            48 to LayoutItem(0x0035, 0x221a),
            53 to LayoutItem(0x0036, 0x03c0),
            49 to LayoutItem(0x0037, 0x00f7),
            37 to LayoutItem(0x0038, 0x00d7),
            43 to LayoutItem(0x0039, 0x00b6),
            ...
            38 to LayoutItem(0x002b, 0x003d),
            39 to LayoutItem(0x0028, 0x007b),
            40 to LayoutItem(0x0029, 0x007d),

            54 to LayoutItem(0x002a, 0x0025),
            52 to LayoutItem(0x0022, 0x00a9),
            31 to LayoutItem(0x0027, 0x00ae),
            50 to LayoutItem(0x003a, 0x2122),
            30 to LayoutItem(0x003b, 0x2713),
            42 to LayoutItem(0x0021, 0x005b),
            41 to LayoutItem(0x003f, 0x005d),
